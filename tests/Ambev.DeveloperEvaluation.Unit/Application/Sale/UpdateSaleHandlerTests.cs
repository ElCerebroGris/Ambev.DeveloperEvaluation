...
namespace Ambev.DeveloperEvaluation.Unit.Application.Sale
{
    ...
    public class UpdateSaleHandlerTests
    {
        ...
        public async Task Handle_ValidRequest_ReturnsUpdatedSale()
        {
            ...
            var existingSale = SaleHandlerTestData.GenerateSale(command.Id);
            ...
            _saleRepository.UpdateAsync(command.Id, Arg.Any<Ambev.DeveloperEvaluation.Domain.Entities.Sale>(), Arg.Any<CancellationToken>()).Returns(updatedSale);
